...
// ---- Touch (FT6336 capacitive, I2C — shared bus with ES8311) ----
...
// ---- Audio (ES8311 codec, I2S + I2C control) ----
constexpr gpio_num_t PIN_I2S_MCK  = GPIO_NUM_4;   // master clock
constexpr gpio_num_t PIN_I2S_BCK  = GPIO_NUM_5;   // bit clock
constexpr gpio_num_t PIN_I2S_WS   = GPIO_NUM_7;   // word select / LRCK
constexpr gpio_num_t PIN_I2S_DOUT = GPIO_NUM_8;   // ESP32 → codec (speaker)
constexpr gpio_num_t PIN_I2S_DIN  = GPIO_NUM_6;   // codec → ESP32 (mic)
constexpr gpio_num_t PIN_AMP_EN   = GPIO_NUM_1;   // amplifier enable (active LOW)
// ES8311 I2C uses shared bus: SDA=GPIO16, SCL=GPIO15
