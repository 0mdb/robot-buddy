...
argument-hint: "[reflex|face|cobs|crc]"
...
### Face MCU protocol
- `esp32-face-v2/main/protocol.h` — face commands, moods, gestures, system modes, v1/v2 envelope, flags
- `esp32-face-v2/main/protocol.cpp` — COBS/CRC16, protocol version negotiation

### Supervisor (Python)
- `supervisor/supervisor/devices/protocol.py` — Python enums mirroring MCU definitions
- `supervisor/supervisor/io/serial_transport.py` — async serial with COBS framing, auto-reconnect
- `supervisor/supervisor/io/cobs.py` — COBS encode/decode
- `supervisor/supervisor/io/crc.py` — CRC16-CCITT
