...
|-----------|----------------|
| `supervisor/io/cobs.py` | `supervisor/io/cobs.py` |
| `supervisor/io/crc.py` | `supervisor/io/crc.py` |
| `supervisor/io/serial_transport.py` | `supervisor/io/serial_transport.py` |
| `supervisor/devices/protocol.py` | `supervisor/devices/protocol.py` |
| `supervisor/devices/reflex_client.py` | `supervisor/devices/reflex_client.py` |
| `supervisor/devices/face_client.py` | `supervisor/devices/face_client.py` |
| `supervisor/devices/expressions.py` | `supervisor/devices/expressions.py` |
| `supervisor/state/supervisor_sm.py` | `supervisor/core/state_machine.py` |
| `supervisor/planner/skill_executor.py` | `supervisor/core/skill_executor.py` |
| `supervisor/planner/speech_policy.py` | `supervisor/core/speech_policy.py` |
| `supervisor/api/param_registry.py` | `supervisor/api/param_registry.py` |
| `supervisor/api/ws_hub.py` | `supervisor/api/ws_hub.py` |
| `supervisor/mock/mock_reflex.py` | `supervisor/mock/mock_reflex.py` |
| `supervisor/inputs/detectors.py` | used inside `supervisor/workers/vision_worker.py` |
...
- **Testable:** `pytest supervisor/tests/test_messages.py`
...
- **Testable:** `python -m supervisor --mock` — state machine transitions, safety, twist output
...
After each phase:
1. `ruff check supervisor/ && ruff format --check supervisor/`
2. `pytest supervisor/tests/ -v`
