...
def _build_vision_worker_config(registry: object) -> dict[str, object]:
    ...
    return {
        ...
        # Camera / ISP (Picamera2/libcamera)
        "rotate_deg": _get_int(registry, "vision.rotate_deg", 180),
        "hfov_deg": _get_float(registry, "vision.hfov_deg", 66.0),
        "af_mode": _get_int(registry, "vision.af_mode", 2),
        "lens_position": _get_float(registry, "vision.lens_position", 1.0),
        "ae_enable": _get_int(registry, "vision.ae_enable", 1),
        "exposure_time_us": _get_int(registry, "vision.exposure_time_us", 10_000),
        "analogue_gain": _get_float(registry, "vision.analogue_gain", 1.0),
        "awb_enable": _get_int(registry, "vision.awb_enable", 1),
        "colour_gain_r": _get_float(registry, "vision.colour_gain_r", 1.0),
        "colour_gain_b": _get_float(registry, "vision.colour_gain_b", 1.0),
        "brightness": _get_float(registry, "vision.brightness", 0.0),
        "contrast": _get_float(registry, "vision.contrast", 1.0),
        "saturation": _get_float(registry, "vision.saturation", 1.0),
        "sharpness": _get_float(registry, "vision.sharpness", 1.0),
        "jpeg_quality": _get_int(registry, "vision.jpeg_quality", 50),
    }
