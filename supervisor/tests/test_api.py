"""Tests for supervisor API layer (http_server, ws_hub)."""
...
from supervisor.core.state import Mode, RobotState, WorldState, DesiredTwist
...
class TestWsHub:
    ...
    def test_broadcast_schema(self):
        ...
        with patch("supervisor.api.ws_hub.asyncio.ensure_future") as mock_ef:
            hub.broadcast_telemetry({"mode": "IDLE"})
