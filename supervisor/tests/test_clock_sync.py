...
from supervisor.core.state import ClockSync
...
def _send_and_respond(
    ...
    *,
    ...
    with patch(
        "supervisor.devices.clock_sync.time.monotonic_ns", return_value=t_pi_rx_ns
    ):
...
class TestClockSyncEngine:
    ...
    def test_degraded_on_stale(self) -> None:
        ...
        with patch(
            "supervisor.devices.clock_sync.time.monotonic_ns",
