...
# Phase C: hybrid preamble tool-call summary + typed per-turn error.
AI_CONVERSATION_TOOL_CALL = "ai.conversation.tool_call"
AI_CONVERSATION_TURN_ERROR = "ai.conversation.turn_error"
