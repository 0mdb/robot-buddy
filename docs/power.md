...
## Goal
Run Jetson Nano + 2× ESP32-S3 + WS2812 face + motors from a 2S pack reliably.

## Recommended topology
- 2S pack -> main fuse -> switch -> split rails
  - Dirty rail: motors (TB6612 VM)
  - Clean rail: 2S -> high-quality buck -> 5V bus (Jetson + ESP32s + LEDs)

## TODO
- [ ] Decide 5V buck part + current rating (target 8–10A class)
- [ ] Add bulk capacitance near Jetson 5V input
