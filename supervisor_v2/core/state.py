"""Split state types for supervisor v2 (MIGRATION.md § State Split).
...
from supervisor_v2.devices.expressions import FACE_MOOD_TO_EMOTION
from supervisor_v2.devices.protocol import Fault, RangeStatus
